    ...
    private suspend fun onError(exception: Throwable) {
        when (exception) {
            ...
            is HttpException -> {
                ...
                val gson = Gson()
                val type = object : TypeToken<com.ziacare.app.data.model.ErrorModel>() {}.type
                var errorResponse: com.ziacare.app.data.model.ErrorModel? = gson.fromJson(errorBody?.charStream(), type)
