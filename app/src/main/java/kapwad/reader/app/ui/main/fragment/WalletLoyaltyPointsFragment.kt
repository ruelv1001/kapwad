...
import kapwad.reader.app.databinding.FragmentLoyaltyPointsWalletBinding
...
@AndroidEntryPoint
class WalletLoyaltyPointsFragment : Fragment(), InboundOutboundAdapter.InboundOutboundCallback, SwipeRefreshLayout.OnRefreshListener {

    private var _binding: FragmentLoyaltyPointsWalletBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLoyaltyPointsWalletBinding.inflate(
            inflater,
            container,
            false
        )
    ...
    private fun setUpAdapter() = binding.run {
        swipeRefreshLayout.setOnRefreshListener(this@WalletLoyaltyPointsFragment)
        adapter = InboundOutboundAdapter(this@WalletLoyaltyPointsFragment)
    ...
    companion object{
        fun newInstance() = WalletLoyaltyPointsFragment()
