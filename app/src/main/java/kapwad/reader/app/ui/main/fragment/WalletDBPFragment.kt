...
import kapwad.reader.app.databinding.FragmentDbpWalletBinding
...
@AndroidEntryPoint
class WalletDBPFragment : Fragment(), InboundOutboundAdapter.InboundOutboundCallback, SwipeRefreshLayout.OnRefreshListener {

    private var _binding: FragmentDbpWalletBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDbpWalletBinding.inflate(
            inflater,
            container,
            false
        )
    ...
    private fun setUpAdapter() = binding.run {
        swipeRefreshLayout.setOnRefreshListener(this@WalletDBPFragment)
        adapter = InboundOutboundAdapter(this@WalletDBPFragment)
    ...
    companion object{
        fun newInstance() = WalletDBPFragment()
