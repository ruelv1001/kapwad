package kapwad.reader.app.ui.phmarket.activity
...
import kapwad.reader.app.databinding.ActivityPhMarketBinding
...
@AndroidEntryPoint
class PHMarketActivity : AppCompatActivity() {

    private lateinit var binding: ActivityPhMarketBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPhMarketBinding.inflate(layoutInflater)
    ...
    companion object {
        ...
        fun getIntent(context: Context): Intent {
            return Intent(context, PHMarketActivity::class.java)
        }
    }
}