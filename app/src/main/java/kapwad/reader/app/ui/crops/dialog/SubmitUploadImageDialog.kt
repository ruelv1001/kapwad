...
import kapwad.reader.app.databinding.DialogUploadImageBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class SubmitUploadImageDialog : DialogFragment() {

    private var viewBinding: DialogUploadImageBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewBinding = DialogUploadImageBinding.bind(view)
        setClickListener()
    }
    ...
    interface SuccessCallBack {
        ...
        fun onCancel(dialog: SubmitUploadImageDialog)
    }

    companion object {
        fun newInstance(callback: SuccessCallBack? = null, imagePos: String) =
            SubmitUploadImageDialog().apply {
                this.callback = callback
                this.imagePos = imagePos
            }

        val TAG: String = SubmitUploadImageDialog::class.java.simpleName
    }
}
