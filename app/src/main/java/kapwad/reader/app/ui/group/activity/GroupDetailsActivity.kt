package kapwad.reader.app.ui.group.activity
...
import kapwad.reader.app.databinding.ActivityGroupDetailsBinding
import kapwad.reader.app.ui.group.adapter.AssistanceAdapter
...
class GroupDetailsActivity : AppCompatActivity(), SwipeRefreshLayout.OnRefreshListener,
    ...
    private fun setDetails(data: GroupData) = binding.run {
       ...
       // adminTextView.text = data.admin_only_count.toString()
        ...
        qrLayout.qrImageView.setImageBitmap(setQRv2(this@GroupDetailsActivity, data.qrcode_value))
